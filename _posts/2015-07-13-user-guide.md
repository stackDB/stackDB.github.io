...
1. **Tags:** It's unnecessary to use supplements as tags. Think of them as way to categorize the stack. The goals of your stack are a great way to start. If it's possible please use the suggested tags to avoid duplicates.